import importlib
from .babel import data_en, data_es, data_fr
...
class SenticNet(object):
    ...
    def __init__(self, language="en"):
        #data_module = importlib.import_module("data_" + language, package='.babel')
        #self.data = data_module.senticnet

        if language == 'en':
            self.data = data_en.senticnet
        elif language == 'es':
            self.data = data_es.senticnet
        elif language == 'fr':
            self.data = data_fr.senticnet
        else:
            raise  Exception("Not support language")
